...
namespace projeto2
{
    public partial class Form1 : Form
    {
        ...
        private void acessosBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            ...
            this.tableAdapterManager.UpdateAll(this._Login_sdf_cj3021947DataSet);
        ...
        {
            string ConnectString = Properties.Settings.Default.Login_sdf_cj3021947ConnectionString;
